...
- bg `#FAFAFA` / white sections; text black + gray-500/600; single accent blue `#0000FF`; hairline borders `#E5E5E5`; strong borders `border-black`; brutalist shadow `shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]`.
